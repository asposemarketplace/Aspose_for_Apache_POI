package featurescomparison.workingwithpresentation.createautoshapes.java;
...
public class ApacheAutoShapes
{
	...
	{
		String dataPath = "src/featurescomparison/workingwithpresentation/createautoshapes/data/";
		...
		FileOutputStream out = new FileOutputStream(dataPath + "ApacheShapes.ppt");
		ppt.write(out);
		out.close();
