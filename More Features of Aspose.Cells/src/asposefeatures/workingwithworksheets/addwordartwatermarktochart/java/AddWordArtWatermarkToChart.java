package asposefeatures.workingwithworksheets.addwordartwatermarktochart.java;
...
public class AddWordArtWatermarkToChart
{
	...
	{
		String dataPath = "src/asposefeatures/workingwithworksheets/addwordartwatermarktochart/data/";
