package asposefeatures.loadingsavingandconverting.workingwithdigitalsignature.java;
...
public class AsposeDigitalSignatures
{
	...
	{
		String dataPath = "src/asposefeatures/loadingsavingandconverting/workingwithdigitalsignature/data/";
